...
<head>
    ...
    <style>
       body {
    background-color: white; /* Màu nền mong muốn */
}
.duong_vien {
    border: none; /* Xóa đường viền hiện có */
    height: 2px; /* Đặt chiều cao của đường viền */
    background-color: #28395a; /* Đặt màu nền cho đường viền */
}
    </style>
</head>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github mr-2 icon-inline">
                                    ...
                                    </svg><a class="changePass" href="change_password.php">Change password</a></h6>
